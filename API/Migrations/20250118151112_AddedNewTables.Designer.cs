...
namespace API.Migrations
{
    ...
    [Migration("20250118151112_AddedNewTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.ProductMagicBagItem", b =>
                {
                    ...
                    b.HasIndex("MagicBagId", "ProductId")
                        .IsUnique();
            ...
            modelBuilder.Entity("API.Models.Transactions", b =>
                {
                    ...
                    b.Property<DateTime>("PickUpdateDate")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("MagicBagId")
                        .IsUnique();

                    b.HasIndex("UserId", "MagicBagId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1f516f62-b2d3-46e7-885f-cd9ce476be90",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "691c37a1-bcd2-458a-809a-17770fe4749c",
                            Name = "Partner",
                            NormalizedName = "PARTNER"
                        },
                        new
                        {
                            Id = "824624b3-19b3-4516-b93d-b9893ddcd9a2",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Feedback", b =>
                {
                    b.HasOne("API.Models.Transactions", "Transactions")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Models.Transactions", b =>
                {
                    b.HasOne("API.Models.MagicBag", "MagicBag")
                        ...
                        .HasForeignKey("API.Models.Transactions", "MagicBagId");
